...
from settings import API_ID, API_HASH, forwards, get_forward, update_offset, parse_message
            ...
            for forward in forwards:
                ...
                async for message in client.iter_messages(_(from_chat), reverse=True, offset_id=offset):
                    ...
                    try:
                        ...
                        print(message)
                        instrument, tp, sl, signal_date = parse_message(message.message)
                        
                        # When Successful, send message to telegram
